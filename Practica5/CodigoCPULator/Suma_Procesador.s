...
ReadB:
	...
	// Luego de leer B, pasamos directamente a mostrar R

ShowR:
	ADD		R6, R4, R5			// R6 = A + B -> A + B = R
	STR		R6, [R1, #4]		// Escribimos el numero R en los LEDs -> (Binary)
	STR		R6, [R1, #8]		// Escribimos el numero R en los 4 LSB 7-Segmentos -> (Signed)
